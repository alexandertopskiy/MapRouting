...
class HalfModalPresentationController : UIPresentationController {
    ...
    var panOnPreviousViewGestureRecognizer: UIPanGestureRecognizer
...
//        blurEffectView.contentView.addSubview(vibrancyEffectView)
    ...
    override init(presentedViewController: UIViewController, presenting presentingViewController: UIViewController?) {
        ...
        self.tapGestureRecognizer = UITapGestureRecognizer() // MARK: - !!!
        self.panOnPreviousViewGestureRecognizer = UIPanGestureRecognizer() // MARK: - !!!
        
        super.init(presentedViewController: presentedViewController, presenting: presentingViewController)
        panGestureRecognizer.addTarget(self, action: #selector(onPan(pan:)))
        presentedViewController.view.addGestureRecognizer(panGestureRecognizer)
        
        panOnPreviousViewGestureRecognizer.addTarget(self, action: #selector(onPanOnPreviousView(pan:)))
        tapGestureRecognizer.addTarget(self, action: #selector(onTap(tap:))) // MARK: - !!!
    }
    
    @objc func onPanOnPreviousView(pan: UIPanGestureRecognizer) {
...
//            print("finished transition")
    ...
    override func presentationTransitionWillBegin() {
        ...
        if let containerView = self.containerView, let coordinator = presentingViewController.transitionCoordinator {
            ...
            dimmedView.addGestureRecognizer(panOnPreviousViewGestureRecognizer)
